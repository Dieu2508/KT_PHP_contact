...
<body>
  ...
  if (isset($_REQUEST['submitadd'])) {
    ...
    $congtyadd  = $_REQUEST['congtyadd'];
    danhba::addDB($tenadd, $emailadd, $phoneadd,$addNhom,$congtyadd);
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="form-group row">
              <label for="inputEmail10" class="col-sm-2 col-form-label">
          ...
          <div class="modal-footer">
            ...
            <button type="submit" name="submitnhomadd" class="btn btn-primary" >Lưu</button>
          </div>
        </form>
      </div>
    </div>
      ...
      <form action="" method="get" accept-charset="utf-8">
        <div class="modal-content">
          ...
          <div class="modal-body">
             ...
             <div class="form-group row">
              <label for="inputEmail3" class="col-sm-2 col-form-label" ><i class="fas fa-user-circle" style="font-size: 30px;"></i></label>
              <div class="col-sm-10">
                <input type="text" class="form-control" name="tenadd" id="inputEmail3" placeholder="Tên">
              </div>
            </div>
            <div class="form-group row">
              <label for="inputEmail4" class="col-sm-2 col-form-label"><i class="fas fa-envelope-square"style="font-size: 30px;"></i></label>
              <div class="col-sm-10">
                <input type="text" class="form-control" name="emailadd" id="inputEmail4" placeholder="Email">
              </div>
            </div>
            <div class="form-group row">
              <label for="inputEmail5" class="col-sm-2 col-form-label"><i class="fas fa-phone"style="font-size: 30px;"></i></label>
              <div class="col-sm-10">
                <input type="text" class="form-control" name="phoneadd" id="inputEmail5" placeholder="Số điện thoại..">
              </div>
            </div>
            <div class="form-group row">
              <label for="inputEmail5" class="col-sm-2 col-form-label"><i class="fas fa-building" style="font-size: 30px;"></i></label>
              <div class="col-sm-10">
                <input type="text" class="form-control" name="congtyadd" id="inputEmail5" placeholder="Chức danh và công ty...">
              </div>
            </div>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Hủy</button>
          <button type="submit" name="submitadd" class="btn btn-primary" >Lưu</button>
        </div>
      </form>
    </div>
  </div>
  ...
  <ul class="info-menu user-info info-top">
   ...
   <li class="profile">
     <a href="#" data-toggle="dropdown" class="toggle" aria-expanded="false">
       ...
       <span style="color: #1a73e8;font-weight: 600;"><?php 
       $asds = danhba::showname();
       echo $asds; ?><i class="fa fa-angle-down" style="margin-left: 
       5px;"></i></span>
     </a>
     <ul class="dropdown-menu profile fadeIn " style="top: -40px;">
      <li>
        <a href="#settings">
          ...
          Chào <span style="color: #1a73e8; font-weight: 600;"><?php 
          $asds = danhba::showname();
          echo $asds; ?></span>
        </a>
      </li>
  ...
  <ul class="wraplist" style="height: auto;"> 
      ...
      <ul class="item-nhan item-show" style="overflow-y: auto;">
        ...
        foreach ($listnhom as $value) { ?>
          <li ><a href="?mn=<?php echo $value->maNhom; ?>" title="">
            <svg width="20" height="20" viewBox="0 0 24 24" class="NSy2Hd RTiFqe undefined"><path fill="none" d="M0 0h24v24H0V0z"></path><path d="M17.63 5.84C17.27 5.33 16.67 5 16 5L5 5.01C3.9 5.01 3 5.9 3 7v10c0 1.1.9 1.99 2 1.99L16 19c.67 0 1.27-.33 1.63-.84L22 12l-4.37-6.16zM16 17H5V7h11l3.55 5L16 17z"></path></svg>
            <span class="sidebar-icon pl-2" > <?php echo $value->tenNhom; ?></span></a></li>
          <?php }
          ?>
          <li><a href="#" data-toggle="modal" data-target="#exampleModalnhom" title="#">
            ...
            <span class="pl-2">Tạo nhãn</span> </a></li>
    ...
    <li>
      <a href="">
        ...
        <span class="menu-title pl-2">Nhập</span>
      </a>
    </li>
    <li>
      <a href="">
        ...
        <span class="menu-title pl-2">Xuất</span>
      </a>
    </li>
    <li>
      <a href="">
        ...
        <span class="menu-title pl-2">In</span>
      </a>
    </li>
    <hr>
    <li>
      <a href="">
        ...
        <span class="menu-title pl-2">Liên hệ khác</span>
      </a>
    </li>
    </ul>
  </div>  
    ...
    foreach ($dsBD as $value) { ?>
      ...
      <div class="form-check myrow">
        ...
        <label class="form-check-label" for="defaultCheck<?php echo $value->iddb; ?>">
          ...
          <div class="row pt-1 ">
            <div class="col-3">
              <span class="pl-3" style="color: #202124;"><?php echo $value->tendb; ?></span>
            </div>
            <div class="col-4">
              <span style="color: #202124;"><?php echo $value->emaildb; ?></span>
            </div>
            <div class="col-2">
              <span style="color: #202124;"><?php echo $value->sdtdb; ?></span>
            </div>
            <div class="col-3">
              <span style="color: #202124;"><?php echo $value->congtydb; ?></span>
            </div>
          </div>
